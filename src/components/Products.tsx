            ...
            >
              ...
              <div className="p-3 md:p-5 relative z-10">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {/* WhatsApp - visible en móvil y desktop */}
                  <a
                    ...
                    className="flex p-2 md:p-3 rounded-lg md:rounded-xl bg-gradient-to-r from-[#128C7E] to-[#25D366] text-white hover:scale-105 transition-all duration-300 shadow-md"
