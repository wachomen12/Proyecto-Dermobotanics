...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/593959602727?text=${encodeURIComponent(mensaje)}`, '_blank');
  };
          ...
          <div className="hidden lg:block space-y-5">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-5 border border-[#e7dbc2]/30">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://www.facebook.com/share/14nHodiDHZ7/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-[#1877F2] to-[#3B82F6] text-white shadow-lg hover:scale-110 transition">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987H7.898v-2.891h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562v1.875h2.773l-.443 2.891h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
                  </svg>
                </a>
