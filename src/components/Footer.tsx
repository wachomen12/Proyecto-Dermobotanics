      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            <div className="mb-6">
              <div className="inline-block p-3 bg-white rounded-2xl shadow-2xl shadow-[#c9a962]/20 hover:scale-105 transition-transform duration-300">
                <img 
                  src="/logo.png" 
            ...
            <div className="flex gap-3">
              <a
                href="https://www.instagram.com/dermobotanics?igsh=MTlpaWRtYjl2ajF1dQ=="
                target="_blank"
          ...
          {/* Quick Links Premium */}
          <div>
            <h4 className="text-lg font-bold mb-6 bg-gradient-to-r from-[#d4b886] to-[#c9a962] bg-clip-text text-transparent">
              Enlaces
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:0987901837" className="flex items-start gap-3 group">
                  <div className="w-10 h-10 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#c9a962]/10 group-hover:border-[#c9a962]/30 transition-all">
                    <svg className="w-5 h-5 text-[#c9a962]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <span className="text-gray-400 hover:text-[#c9a962] text-sm md:text-base pt-1 transition-colors">0987901837</span>
                </a>
              </li>
        ...
        <div className="mt-12 md:mt-16 pt-8 md:pt-12 border-t border-white/10">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-xl md:text-2xl font-bold mb-3 bg-gradient-to-r from-[#d4b886] to-[#c9a962] bg-clip-text text-transparent">
            ...
            <a
              href="https://wa.me/593987901837?text=Hola%20👋%20Me%20gustaría%20agendar%20una%20cita"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#d4b886] to-[#c9a962] text-white rounded-full font-semibold hover:shadow-2xl hover:shadow-[#c9a962]/40 hover:-translate-y-1 transition-all duration-300"
            >
