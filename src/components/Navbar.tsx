          ...
          <div className="bg-white/95 backdrop-blur-2xl rounded-2xl p-5 space-y-1 shadow-2xl shadow-black/10 border border-[#e7dbc2]/40">
            ...
            <div className="pt-2 space-y-3">
              ...
              <Link
                ...
                target="_blank"
                className="flex items-center justify-center gap-3 py-4 bg-gradient-to-r from-[#1877F2] to-[#3B82F6] text-white rounded-2xl font-semibold shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 hover:-translate-y-0.5 transition-all duration-300"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
